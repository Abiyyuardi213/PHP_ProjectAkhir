      ...
      <div class="container mx-auto px-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          ...
          <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <img src="https://via.placeholder.com/400x300" alt="Product A" class="w-full h-48 object-cover">
            <div class="p-6">
          ...
          <!-- Product Card 2 -->
          <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <img src="https://via.placeholder.com/400x300" alt="Product B" class="w-full h-48 object-cover">
            <div class="p-6">
          ...
          <!-- Product Card 3 -->
          <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <img src="https://via.placeholder.com/400x300" alt="Product C" class="w-full h-48 object-cover">
            <div class="p-6">
              <h3 class="text-lg font-semibold text-gray-800 mb-2">Product C</h3>
              <p class="text-gray-600 text-sm mb-4">Category: Clothing</p>
              <p class="text-gray-800 font-medium">Price: $45.00</p>
              <button class="mt-4 bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 flex items-center">
                <span class="material-icons mr-2">shopping_cart</span> Add to Cart
              </button>
            </div>
          ...
          <!-- Product Card 4 -->
          <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <img src="https://via.placeholder.com/400x300" alt="Product D" class="w-full h-48 object-cover">
            <div class="p-6">
              <h3 class="text-lg font-semibold text-gray-800 mb-2">Product D</h3>
              <p class="text-gray-600 text-sm mb-4">Category: Furniture</p>
              <p class="text-gray-800 font-medium">Price: $150.00</p>
              <button class="mt-4 bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 flex items-center">
                <span class="material-icons mr-2">shopping_cart</span> Add to Cart
              </button>
            </div>
          ...
          <!-- Product Card 5 -->
          <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <img src="https://via.placeholder.com/400x300" alt="Product E" class="w-full h-48 object-cover">
            <div class="p-6">
              <h3 class="text-lg font-semibold text-gray-800 mb-2">Product E</h3>
              <p class="text-gray-600 text-sm mb-4">Category: Sports</p>
              <p class="text-gray-800 font-medium">Price: $80.00</p>
              <button class="mt-4 bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 flex items-center">
                <span class="material-icons mr-2">shopping_cart</span> Add to Cart
              </button>
            </div>
          ...
          <!-- Product Card 6 -->
          <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <img src="https://via.placeholder.com/400x300" alt="Product F" class="w-full h-48 object-cover">
            <div class="p-6">
              <h3 class="text-lg font-semibold text-gray-800 mb-2">Product F</h3>
              <p class="text-gray-600 text-sm mb-4">Category: Health & Beauty</p>
              <p class="text-gray-800 font-medium">Price: $55.00</p>
              <button class="mt-4 bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 flex items-center">
                <span class="material-icons mr-2">shopping_cart</span> Add to Cart
              </button>
            </div>
